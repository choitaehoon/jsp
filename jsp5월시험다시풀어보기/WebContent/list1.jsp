<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*, java.text.* ,java.net.*, p201432038.*"%>
...
<%
	...
	if (st == null)
		st = "";
	String stEncoded = URLEncoder.encode(st, "UTF-8"); // 이렇게 해야 encoding 할때 안전하다.
		...
		<form class="form-inline">
			<div class="form-group">
				<label>정렬</label> <select name="od" class="form-control">
					...
					<option value="3" <%="3".equals(od) ? "selected" : ""%>>작성자 내림차순</option>
					<option value="4" <%="4".equals(od) ? "selected" : ""%>>최신 글 순서</option>
					<option value="5" <%="5".equals(od) ? "selected" : ""%>>제목 오름차순</option>
		...
		<table class="table table-bordered table-condensed">
			...
			<tbody>
				...
				<tr
					...
					<td><%= datetimeFormat.format(article.getWriteTime()) %></td>
