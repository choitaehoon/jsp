<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.net.*, java.util.*, lecture1.*"%>
<%
...
<body>
	<div class="container">
		...
		<form method="post">
			...
			<a
				href="studentDelete1.jsp?id=<%=id%>&pg=<%=pg%>&srchText=<%=srchTextEncoded%>"
				class="btn btn-danger" onclick="return confirm('삭제하시겠습니까?')"> <i
				class="glyphicon glyphicon-trash"></i> 삭제
			</a> <a
				href="studentList1.jsp?pg=<%=pg%>&srchText=<%=srchTextEncoded%>"
